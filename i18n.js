...
const TRANSLATIONS = {
  ...
  fr: {
    ...
    editor_field_name_ph:      'Ex: Dortean',
    editor_field_subtitle:     'Titre ou occupation',
    editor_field_subtitle_ph:  'Ex: Espion de la compagnie',
  ...
  en: {
    ...
    editor_field_name_ph:     'E.g. Dortean',
    editor_field_subtitle:    'Title or occupation',
    editor_field_subtitle_ph: 'E.g. Compagny spy',
